...
To determine the taxonomic position of your genome, we will compare it with reference genomes (Type strains) by calculating digital DNA–DNA hybridization (dDDH) and average nucleotide identity (ANI) values.
